...
print('Load data...')
df_train = pd.read_csv('/cluster/workspace/zhongqiqiang/code/ctr_of_recommendation/GBDT+LR-Demo/data/train.csv')
df_test = pd.read_csv('/cluster/workspace/zhongqiqiang/code/ctr_of_recommendation/GBDT+LR-Demo/data/test.csv')
